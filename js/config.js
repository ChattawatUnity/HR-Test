...
window.HR_CONFIG = {
  ...
  /* ---------------- Part 1 : พิมพ์ภาษาไทย ---------------- */
  PART1_TEXT:
"เมื่อลูกค้ายืนยันการจองระวางเรือแล้ว เจ้าหน้าที่เอกสารจะต้องตรวจสอบรายละเอียดในใบจอง " +
"ให้ครบถ้วน ทั้งชื่อผู้ส่งออก ผู้รับสินค้า ท่าเรือต้นทาง ท่าเรือปลายทาง หมายเลขตู้คอนเทนเนอร์ " +
"และหมายเลขซีล ก่อนจัดทำร่างใบตราส่งสินค้าหรือบิลออฟเลดิ้งส่งให้ลูกค้าตรวจทาน " +
"หากพบข้อผิดพลาดแม้เพียงตัวอักษรเดียว เช่น สะกดชื่อบริษัทผิด หรือระบุน้ำหนักรวมไม่ตรงกับใบกำกับสินค้า " +
"อาจทำให้เอกสารถูกปฏิเสธจากธนาคารและเกิดความล่าช้าในการเคลียร์สินค้าที่ปลายทาง " +
"ดังนั้นเจ้าหน้าที่จึงต้องตรวจทานอย่างละเอียดรอบคอบทุกครั้ง " +
"โดยทั่วไปเรือแม่จะออกจากท่าเรือกรุงเทพทุกวันพฤหัสบดี และใช้เวลาเดินทางไปยังท่าเรือโอซาก้าประมาณ 7 ถึง 10 วัน " +
"หากสินค้าเป็นสินค้าแช่แข็งจะต้องควบคุมอุณหภูมิในตู้ให้อยู่ที่ลบ 18 องศาเซลเซียสตลอดการขนส่ง " +
"และแจ้งเลขที่ใบตราส่ง วันที่เรือออก และวันที่คาดว่าเรือจะถึงปลายทางให้ลูกค้าทราบทางอีเมลภายในวันเดียวกัน " +
"นอกจากนี้ยังต้องติดตามสถานะตู้สินค้าจากสายเรืออย่างต่อเนื่อง เพื่อให้สามารถแจ้งลูกค้าได้ทันทีเมื่อมีการเปลี่ยนแปลงกำหนดการ",
